        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              Turn these numbers into a professional narrative — persona, highlights, growth areas
  ...
  return (
    <div className="grid gap-3 lg:grid-cols-2">
      ...
      <Panel className="lg:col-span-2">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">{insights.codingStyle}</p>
      </Panel>
    </div>
  );
}
